...
class TrainingParams:
    ...
    def __init__(self, params_path: str, model_params_path: str, debug: bool = False):
        ...
        image_resize_height = params.getint("image_resize_height", 221)
        image_resize_width = params.getint("image_resize_width", 221)
        self.image_size = (image_resize_width, image_resize_height)

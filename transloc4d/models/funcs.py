...
from .minkloc import MinkLoc, MinkLoc2,MinkLoc3
...
from .minkfpn import MinkFPN, MinkFPN2, MinkFPN3,Backbone, FPN
...
def get_model(params, device, weights_path=None):
    ...
    elif params.model_params.model == 'NFRCSNet':
    ...
    elif params.model_params.model == 'Test':
        block_module = create_resnet_block(params.model_params.block)
        backbone = MinkFPN3(
            in_channels=in_channels,
            out_channels=params.model_params.feature_size,
